...
class NST:
    ...
    def __init__(self, style_image, content_image, alpha=1e4, beta=1):
        ...
        tf.compat.v1.enable_eager_execution()  # Fixed deprecated eager execution call
    ...
    def scale_image(image):
        ...
        rescaled = resized / 255.0  # Fixed precision issue by using 255.0
        rescaled = tf.clip_by_value(rescaled, 0.0, 1.0)  # Fixed precision here as well
        return rescaled
